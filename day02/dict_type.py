...
# 题: 新建一个字典变量,里面有两个键值对,通过key访问一个值,删除一个键值对,添加一个键值对,
#      更改任意一个值,再新建一个字典,将两个合并

home_works = {"username":"666666","password":"99999"}

def dict_works():
    print(home_works["username"])
    adict.pop("username")
    print(adict)
    adict['dhj'] = 555
    print(adict)
    adict["username"] = "3333"
    print(adict)
    bdict = {"password": "20190530", "table": "84655"}
